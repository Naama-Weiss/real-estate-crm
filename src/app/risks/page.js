  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-8 text-center" dir={getDirection()}>
          {t.general.systemName}
        </h1>
        
        {/* Tabs */}
        <div className="flex justify-center space-x-4 mb-8" dir={getDirection()}>
          <button
        ...
        {/* Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" dir={getDirection()}>
